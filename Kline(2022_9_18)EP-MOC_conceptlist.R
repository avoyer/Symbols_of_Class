...
write.table(tidy_EP_chunk_n, "kline(2022_5_17)EP-MOC_chunkn_conceptlist.csv", row.names = FALSE)
...
### LIST
affluence <- list( "rich" , "wealthy")

employment <- list("work" , "job" , "career" , "occupation" , "profession")

status <- list("distinguished" , "rank")

cultivation <- list("cultured" , "civilized" , "proper" , "refined" , "cultivated")

education <- list("education", "college", "graduate")

morality <- list("good" , "virtuous"  , "decent" , "moral")
...
write.table(tidy_EP_all, "kline(2022_5_17)EP-MOC_all_conceptlist.csv", row.names = FALSE)
...
write.table(tidy_EP_DT, "kline(2022_5_17)EP-MOC_chunks_conceptlist.csv", row.names = FALSE)
...
write.csv(tfidf_EP_cos_sim_df, "kline(2022_5_17)EP-MOC_table1_conceptlist.csv")
