...
ngram1933_58 <- readRDS("ngram1933_58.Rds")
rownames(ngram1933_58) <- tolower(rownames(ngram1933_58))
...
write.table(tidy_EP_chunk_n, "kline(2022_5_17)EP-MOC_chunkn_ngram1933_58.csv", row.names = FALSE)
...
cultivation_list <- list("civilized" , "proper" , "refined" , "cultivated")
...
tidy_EP_DT_1_employment_list <- tidy_EP_chunks_1 %>% 
  ...
  CMDist(cw =c(employment_list), wv=ngram1933_58)
...
tidy_EP_DT_1_status_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(status_list), wv=ngram1933_58)
...
tidy_EP_DT_1_cultivation_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(cultivation_list), wv=ngram1933_58)
...
tidy_EP_DT_1_edu_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(education_list), wv=ngram1933_58)
...
tidy_EP_DT_1_morality_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(morality_list), wv=ngram1933_58)
...
cultivation_bind <- c("civilized" , "proper" , "refined" , "cultivated")
...
affluence <- get_centroid(affluence_bind, ngram1933_58)
employment <- get_centroid(employment_bind, ngram1933_58)
status <- get_centroid(status_bind, ngram1933_58)
cultivation <- get_centroid(cultivation_bind, ngram1933_58)
education <- get_centroid(education_bind, ngram1933_58)
morality <- get_centroid(morality_bind, ngram1933_58)
...
tidy_EP_affluence <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = affluence, wv=ngram1933_58)
...
tidy_EP_employment <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = employment, wv=ngram1933_58)
...
tidy_EP_status <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = status, wv=ngram1933_58)
...
tidy_EP_cultivation <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = cultivation, wv=ngram1933_58)
...
tidy_EP_education <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = education, wv=ngram1933_58)
...
tidy_EP_morality <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = morality, wv=ngram1933_58)
...
write.table(tidy_EP_all, "kline(2022_5_17)EP-MOC_all_ngram1933_58.csv", row.names = FALSE)
...
tidy_EP_DT_32_affluence <- tidy_EP_chunks_32 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
    CMDist(cw =c("affluence"), wv=ngram1933_58)
...
write.table(tidy_EP_DT, "kline(2022_5_17)EP-MOC_chunks_ngram1933_58.csv", row.names = FALSE)
...
write.csv(tfidf_EP_cos_sim_df, "kline(2022_5_17)EP-MOC_table1_ngram1933_58.csv")
