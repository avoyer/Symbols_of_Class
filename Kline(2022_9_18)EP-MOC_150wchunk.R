...
#   6 determine chunk size -- n/a for this supplement

tidy_EP_chunk_n <-   mutate(tidy_EP, id = as.numeric(rownames(tidy_EP)))

write.table(tidy_EP_chunk_n, "kline(2022_5_17)EP-MOC_chunkn-150wchunk.csv", row.names = FALSE)
...
# if average words per edition is ~2000*70, roughly average 933, use 1000

set.seed(1)
strap1 <- sample(1:1000, 1000, replace=TRUE)

set.seed(2)
strap2 <- sample(1:1000, 1000, replace=TRUE)

set.seed(3)
strap3 <- sample(1:1000, 1000, replace=TRUE)

set.seed(4)
strap4 <- sample(1:1000, 1000, replace=TRUE)

set.seed(5)
strap5 <- sample(1:1000, 1000, replace=TRUE)

set.seed(6)
strap6 <- sample(1:1000, 1000, replace=TRUE)

set.seed(7)
strap7 <- sample(1:1000, 1000, replace=TRUE)

set.seed(8)
strap8 <- sample(1:1000, 1000, replace=TRUE)

set.seed(9)
strap9 <- sample(1:1000, 1000, replace=TRUE)



set.seed(10)
strap10 <- sample(1:1000, 1000, replace=TRUE)

set.seed(11)
strap11 <- sample(1:1000, 1000, replace=TRUE)

set.seed(12)
strap12 <- sample(1:1000, 1000, replace=TRUE)

set.seed(13)
strap13 <- sample(1:1000, 1000, replace=TRUE)

set.seed(14)
strap14 <- sample(1:1000, 1000, replace=TRUE)

set.seed(15)
strap15 <- sample(1:1000, 1000, replace=TRUE)

set.seed(16)
strap16 <- sample(1:1000, 1000, replace=TRUE)

set.seed(17)
strap17 <- sample(1:1000, 1000, replace=TRUE)

set.seed(18)
strap18 <- sample(1:1000, 1000, replace=TRUE)

set.seed(19)
strap19 <- sample(1:1000, 1000, replace=TRUE)
...
set.seed(20)
strap20 <- sample(1:1000, 1000, replace=TRUE)

set.seed(21)
strap21 <- sample(1:1000, 1000, replace=TRUE)

set.seed(22)
strap22 <- sample(1:1000, 1000, replace=TRUE)

set.seed(23)
strap23 <- sample(1:1000, 1000, replace=TRUE)

set.seed(24)
strap24 <- sample(1:1000, 1000, replace=TRUE)

set.seed(25)
strap25 <- sample(1:1000, 1000, replace=TRUE)

set.seed(26)
strap26 <- sample(1:1000, 1000, replace=TRUE)

set.seed(27)
strap27 <- sample(1:1000, 1000, replace=TRUE)

set.seed(28)
strap28 <- sample(1:1000, 1000, replace=TRUE)

set.seed(29)
strap29 <- sample(1:1000, 1000, replace=TRUE)
...
set.seed(30)
strap30 <- sample(1:1000, 1000, replace=TRUE)

set.seed(31)
strap31 <- sample(1:1000, 1000, replace=TRUE)

set.seed(32)
strap32 <- sample(1:1000, 1000, replace=TRUE)

set.seed(33)
strap33 <- sample(1:1000, 1000, replace=TRUE)

set.seed(34)
strap34 <- sample(1:1000, 1000, replace=TRUE)

set.seed(35)
strap35 <- sample(1:1000, 1000, replace=TRUE)

set.seed(36)
strap36 <- sample(1:1000, 1000, replace=TRUE)

set.seed(37)
strap37 <- sample(1:1000, 1000, replace=TRUE)

set.seed(38)
strap38 <- sample(1:1000, 1000, replace=TRUE)

set.seed(39)
strap39 <- sample(1:1000, 1000, replace=TRUE)
...
set.seed(40)
strap40 <- sample(1:1000, 1000, replace=TRUE)

set.seed(41)
strap41 <- sample(1:1000, 1000, replace=TRUE)

set.seed(42)
strap42 <- sample(1:1000, 1000, replace=TRUE)

set.seed(43)
strap43 <- sample(1:1000, 1000, replace=TRUE)

set.seed(44)
strap44 <- sample(1:1000, 1000, replace=TRUE)

set.seed(45)
strap45 <- sample(1:1000, 1000, replace=TRUE)

set.seed(46)
strap46 <- sample(1:1000, 1000, replace=TRUE)

set.seed(47)
strap47 <- sample(1:1000, 1000, replace=TRUE)

set.seed(48)
strap48 <- sample(1:1000, 1000, replace=TRUE)

set.seed(49)
strap49 <- sample(1:1000, 1000, replace=TRUE)
...
set.seed(50)
strap50 <- sample(1:1000, 1000, replace=TRUE)

set.seed(51)
strap51 <- sample(1:1000, 1000, replace=TRUE)

set.seed(52)
strap52 <- sample(1:1000, 1000, replace=TRUE)

set.seed(53)
strap53 <- sample(1:1000, 1000, replace=TRUE)

set.seed(54)
strap54 <- sample(1:1000, 1000, replace=TRUE)

set.seed(55)
strap55 <- sample(1:1000, 1000, replace=TRUE)

set.seed(56)
strap56 <- sample(1:1000, 1000, replace=TRUE)

set.seed(57)
strap57 <- sample(1:1000, 1000, replace=TRUE)

set.seed(58)
strap58 <- sample(1:1000, 1000, replace=TRUE)

set.seed(59)
strap59 <- sample(1:1000, 1000, replace=TRUE)
...
set.seed(60)
strap60 <- sample(1:1000, 1000, replace=TRUE)

set.seed(61)
strap61 <- sample(1:1000, 1000, replace=TRUE)

set.seed(62)
strap62 <- sample(1:1000, 1000, replace=TRUE)

set.seed(63)
strap63 <- sample(1:1000, 1000, replace=TRUE)

set.seed(64)
strap64 <- sample(1:1000, 1000, replace=TRUE)

set.seed(65)
strap65 <- sample(1:1000, 1000, replace=TRUE)

set.seed(66)
strap66 <- sample(1:1000, 1000, replace=TRUE)

set.seed(67)
strap67 <- sample(1:1000, 1000, replace=TRUE)

set.seed(68)
strap68 <- sample(1:1000, 1000, replace=TRUE)

set.seed(69)
strap69 <- sample(1:1000, 1000, replace=TRUE)
...
set.seed(70)
strap70 <- sample(1:1000, 1000, replace=TRUE)

set.seed(71)
strap71 <- sample(1:1000, 1000, replace=TRUE)

set.seed(72)
strap72 <- sample(1:1000, 1000, replace=TRUE)

set.seed(73)
strap73 <- sample(1:1000, 1000, replace=TRUE)

set.seed(74)
strap74 <- sample(1:1000, 1000, replace=TRUE)

set.seed(75)
strap75 <- sample(1:1000, 1000, replace=TRUE)

set.seed(76)
strap76 <- sample(1:1000, 1000, replace=TRUE)

set.seed(77)
strap77 <- sample(1:1000, 1000, replace=TRUE)

set.seed(78)
strap78 <- sample(1:1000, 1000, replace=TRUE)

set.seed(79)
strap79 <- sample(1:1000, 1000, replace=TRUE)



set.seed(80)
strap80 <- sample(1:1000, 1000, replace=TRUE)

set.seed(81)
strap81 <- sample(1:1000, 1000, replace=TRUE)

set.seed(82)
strap82 <- sample(1:1000, 1000, replace=TRUE)

set.seed(83)
strap83 <- sample(1:1000, 1000, replace=TRUE)

set.seed(84)
strap84 <- sample(1:1000, 1000, replace=TRUE)

set.seed(85)
strap85 <- sample(1:1000, 1000, replace=TRUE)

set.seed(86)
strap86 <- sample(1:1000, 1000, replace=TRUE)

set.seed(87)
strap87 <- sample(1:1000, 1000, replace=TRUE)

set.seed(88)
strap88 <- sample(1:1000, 1000, replace=TRUE)

set.seed(89)
strap89 <- sample(1:1000, 1000, replace=TRUE)



set.seed(90)
strap90 <- sample(1:1000, 1000, replace=TRUE)

set.seed(91)
strap91 <- sample(1:1000, 1000, replace=TRUE)

set.seed(92)
strap92 <- sample(1:1000, 1000, replace=TRUE)

set.seed(93)
strap93 <- sample(1:1000, 1000, replace=TRUE)

set.seed(94)
strap94 <- sample(1:1000, 1000, replace=TRUE)

set.seed(95)
strap95 <- sample(1:1000, 1000, replace=TRUE)

set.seed(96)
strap96 <- sample(1:1000, 1000, replace=TRUE)

set.seed(97)
strap97 <- sample(1:1000, 1000, replace=TRUE)

set.seed(98)
strap98 <- sample(1:1000, 1000, replace=TRUE)

set.seed(99)
strap99 <- sample(1:1000, 1000, replace=TRUE)

set.seed(100)
strap100 <- sample(1:1000, 1000, replace=TRUE)
...
tidy_EP_DT_1_employment_list <- tidy_EP_chunks_1 %>% 
  ...
  CMDist(cw =c(employment_list), wv=fastTM)
...
tidy_EP_DT_1_status_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(status_list), wv=fastTM)
...
tidy_EP_DT_1_cultivation_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(cultivation_list), wv=fastTM)
...
tidy_EP_DT_1_edu_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(education_list), wv=fastTM)
...
tidy_EP_DT_1_morality_list <- tidy_EP_chunks_1 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cw =c(morality_list), wv=fastTM)
...
affluence <- get_centroid(affluence_bind, fastTM)
employment <- get_centroid(employment_bind, fastTM)
status <- get_centroid(status_bind, fastTM)
cultivation <- get_centroid(cultivation_bind, fastTM)
education <- get_centroid(education_bind, fastTM)
morality <- get_centroid(morality_bind, fastTM)
...
tidy_EP_employment <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = employment, wv=fastTM)
...
tidy_EP_cultivation <- tidy_EP_full %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
  CMDist(cv = cultivation, wv=fastTM)
...
write.table(tidy_EP_all, "kline(2022_5_17)EP-MOC_all-150wchunk.csv", row.names = FALSE)
...
tidy_EP_DT_32_affluence <- tidy_EP_chunks_32 %>% 
  cast_dtm(term = word, 
           ...
           weighting = tm::weightTf)  %>%
  removeSparseTerms(.999) %>%
    CMDist(cw =c("affluence"), wv=fastTM)
...
write.table(tidy_EP_DT, "kline(2022_5_17)EP-MOC_chunks-150wchunk.csv", row.names = FALSE)
...
write.csv(tfidf_EP_cos_sim_df, "kline(2022_5_17)EP-MOC_table1-150wchunk.csv")

## For appendix: test with all chunks


##  components of class
tidy_EP_DT_affluence <- tidy_EP_chunks %>% 
  cast_dtm(term = word, 
           document = unique, 
           value = n, 
           weighting = tm::weightTf)  %>%
...
tidy_EP_DT_employment <- tidy_EP_chunks %>% 
  cast_dtm(term = word, 
           document = unique, 
           value = n, 
           weighting = tm::weightTf)  %>%
...
tidy_EP_DT_status <- tidy_EP_chunks %>% 
  cast_dtm(term = word, 
           document = unique, 
           value = n, 
           weighting = tm::weightTf)  %>%
...
tidy_EP_DT_cultivation <- tidy_EP_chunks %>% 
  cast_dtm(term = word, 
           document = unique, 
           value = n, 
           weighting = tm::weightTf)  %>%
...
tidy_EP_DT_morality <- tidy_EP_chunks %>% 
  cast_dtm(term = word, 
           document = unique, 
           value = n, 
           weighting = tm::weightTf)  %>%
...
tidy_EP_DT_all <- inner_join(tidy_EP_DT_affluence, tidy_EP_DT_employment)
tidy_EP_DT_all <- inner_join(tidy_EP_DT_all, tidy_EP_DT_status)
tidy_EP_DT_all <- inner_join(tidy_EP_DT_all, tidy_EP_DT_cultivation)
tidy_EP_DT_all <- inner_join(tidy_EP_DT_all, tidy_EP_DT_edu)
tidy_EP_DT_all <- inner_join(tidy_EP_DT_all, tidy_EP_DT_morality)


 

close_affluence_chunks <- tidy_EP_DT_all %>%
  slice_max(cmd.rich.centroid.1, n=10) %>%
  mutate(unique = as.numeric(docs))

close_employment_chunks <- tidy_EP_DT_all %>%
  slice_max(cmd.work.centroid.1, n=10) %>%
  mutate(unique = as.numeric(docs))

close_status_chunks <- tidy_EP_DT_all %>%
  slice_max(cmd.distinguished.centroid.1, n=10) %>%
  mutate(unique = as.numeric(docs))

close_cultivation_chunks <- tidy_EP_DT_all %>%
  slice_max(cmd.cultured.centroid.1, n=10) %>%
  mutate(unique = as.numeric(docs))

close_edu_chunks <- tidy_EP_DT_all %>%
  slice_max(cmd.education.centroid.1, n=10) %>%
  mutate(unique = as.numeric(docs))

close_morality_chunks <- tidy_EP_DT_all %>%
  slice_max(cmd.good.centroid.1, n=10) %>%
  mutate(unique = as.numeric(docs))




close_affluence_words <- left_join(close_affluence_chunks, tidy_EP_chunks)
close_employment_words <- left_join(close_employment_chunks, tidy_EP_chunks)
close_status_words <- left_join(close_status_chunks, tidy_EP_chunks)
close_cultivation_words <- left_join(close_cultivation_chunks, tidy_EP_chunks)
close_edu_words <- left_join(close_edu_chunks, tidy_EP_chunks)
close_morality_words <- left_join(close_morality_chunks, tidy_EP_chunks)

library(reshape2)
affluence_wide <- dcast(close_affluence_words, unique   ~ word , value.var="word")
affluence_wide <- mutate(affluence_wide, marker = "affluence")

employment_wide <- dcast(close_employment_words, unique ~ word, value.var="word")
employment_wide <- mutate(employment_wide, marker = "employment")

status_wide <- dcast(close_status_words, unique ~ word, value.var="word")
status_wide <- mutate(status_wide, marker = "status")

cultivation_wide <- dcast(close_cultivation_words, unique  ~ word, value.var="word")
cultivation_wide <- mutate(cultivation_wide, marker = "cultivation")

edu_wide <- dcast(close_edu_words, unique  ~ word, value.var="word")
edu_wide <- mutate(edu_wide, marker = "edu")

morality_wide <- dcast(close_morality_words, unique ~ word, value.var="word")
morality_wide <- mutate(morality_wide, marker = "morality")


close_words_wide <- full_join(affluence_wide, employment_wide)
close_words_wide <- full_join(close_words_wide, status_wide)
close_words_wide <- full_join(close_words_wide, cultivation_wide)
close_words_wide <- full_join(close_words_wide, edu_wide)
close_words_wide <- full_join(close_words_wide, morality_wide)


write.csv(close_words_wide, "kline(2022_5_17)EP-MOC_IRR.csv")
