...
write.table(tidy_EP_chunk_n, "kline(2022_5_17)EP-MOC_chunkn-kozlowski.csv", row.names = FALSE)
...
employment_bind <- c("employer", "employee", "owner", "worker", "work", "owner", "industrialist", "laborer", "labor", "capitalist", "manager", "staff", "boss", "foreman", "supervisor", "superintendent")

status_bind <- c("prestigious", "honorable", "esteemed", "influential", "reputable", "distinguished", "eminent", "illustrious", "renowned", "acclaimed", "dignitary", "venerable", "exalted", "estimable", "prominent")

cultivation_bind <- c("cultivated", "cultured", "civil", "courteous", "proper", "polite", "cordial", "formal", "urbane", "polished", "refined", "civility", "civil", "urbanity", "edified", "mannerly", "polished", "gracious", "obliging", "cultured", "genteel", "mannered", "polite")

education_bind <- c("educated", "uneducated", "knowledgeable", "ignorant", "trained", "taught", "literate", "schooled", "tutored", "lettered")

morality_bind <- c("good", "evil", "moral", "immoral", "honest", "dishonest", "virtuous", "sinful", "virtue", "vice", "righteous", "wicked", "chaste", "transgressive", "principled", "unquestionable", "noble", "nefarious", "uncorrupt", "corrupt", "scrupulous", "altruistic", "selfish", "chivalrous", "honest", "commendable", "pure", "dignified", "holy", "valiant", "fiendish", "upstanding", "guiltless", "guilty", "decent", "indecent", "chaste", "righteous", "ethical", "unethical")
...
write.table(tidy_EP_all, "kline(2022_5_17)EP-MOC_all-kozlowski-kozlowski.csv", row.names = FALSE)
...
write.table(tidy_EP_DT, "kline(2022_5_17)EP-MOC_chunks-kozlowski-kozlowski.csv", row.names = FALSE)
...
write.csv(tfidf_EP_cos_sim_df, "kline(2022_5_17)EP-MOC_table1-kozlowski.csv")
